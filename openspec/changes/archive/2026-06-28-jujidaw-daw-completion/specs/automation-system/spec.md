...
Automation lanes for synth and mixer parameters. Supports manual draw (point-by-point editing) and live touch recording (arm a param, turn a knob while transport plays, record the movement into the lane). Persisted per-clip and in the arrangement.
